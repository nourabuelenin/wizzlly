...
export default function HomepageHowWeWork({ dict }: any) {
  return (
    <section className="bg-linear-to-tr from-[#032d79] to-[#0eaeef] -mt-5 py-10 md:py-24 rounded-t-2xl text-white">
      <div className="container mx-auto px-4 md:px-10 grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-16 items-start">
        {/* Left Side */}
        <div className="flex flex-col gap-4 md:gap-6 h-full justify-center">
          ...
          <h3 className="font-medium text-3xl md:text-4xl lg:text-6xl leading-tight">
